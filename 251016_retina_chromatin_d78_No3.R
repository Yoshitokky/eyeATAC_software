...
print(cell_counts)
# Early markers+ RPC1_d78     Early markers+ RPC2_d78 
# 1248                         680 
# Early markers+ RPC3_d78         ELAVL2+/4+ RPC2_d78 
# 650                         472 
# ELAVL2+/4+ RPC1_d78   ONECUT1+/2+/LHX1+ RPC_d78 
# 416                         360 
# ONECUT1+/2+/PTF1A+ RPC1_d78         ELAVL2+/4+ RPC3_d78 
# 328                         323 
# ONECUT1+/MEIS2+ RPC3_d78 ONECUT1+/2+/PTF1A+ RPC2_d78 
# 303                         282 
...
saveRDS(object = RNA_d78, file = "251007_retina_chromatin_d78_RNAseq_No3.rds")
saveRDS(object = multiome_d78, file = "251007_retina_chromatin_d78_ATACseq_No3.rds")
...
#   [1] scales_1.4.0         future_1.67.0        patchwork_1.3.2      ggplot2_4.0.0       
# [5] GenomicRanges_1.56.2 GenomeInfoDb_1.40.1  IRanges_2.38.1       S4Vectors_0.42.1    
# [9] BiocGenerics_0.50.0  Seurat_5.3.0         SeuratObject_5.2.0   sp_2.2-0            
# [13] Signac_1.15.0       
# 
...
# [10] spatstat.explore_3.5-3  Rsamtools_2.20.0        RcppRoll_0.3.1         
# [13] htmltools_0.5.8.1       sctransform_0.4.2       parallelly_1.45.1      
...
# [28] fastmap_1.2.0           GenomeInfoDbData_1.2.12 fitdistrplus_1.2-4     
# [31] shiny_1.11.1            digest_0.6.37           tensor_1.5.1           
# [34] RSpectra_0.16-2         irlba_2.3.5.1           labeling_0.4.3         
# [37] progressr_0.16.0        spatstat.sparse_3.1-0   httr_1.4.7             
# [40] polyclip_1.10-7         abind_1.4-8             compiler_4.4.1         
# [43] withr_3.0.2             S7_0.2.0                BiocParallel_1.38.0    
# [46] fastDummies_1.7.5       MASS_7.3-61             tools_4.4.1            
# [49] lmtest_0.9-40           httpuv_1.6.16           future.apply_1.20.0    
# [52] goftest_1.2-3           glue_1.8.0              nlme_3.1-165           
# [55] promises_1.3.3          grid_4.4.1              Rtsne_0.17             
# [58] cluster_2.1.6           reshape2_1.4.4          generics_0.1.4         
# [61] gtable_0.3.6            spatstat.data_3.1-8     tidyr_1.3.1            
# [64] data.table_1.17.8       XVector_0.44.0          spatstat.geom_3.6-0    
# [67] RcppAnnoy_0.0.22        ggrepel_0.9.6           RANN_2.6.2             
# [70] pillar_1.11.1           stringr_1.5.2           spam_2.11-1            
# [73] RcppHNSW_0.6.0          later_1.4.4             splines_4.4.1          
# [76] dplyr_1.1.4             lattice_0.22-5          survival_3.7-0         
# [79] deldir_2.0-4            tidyselect_1.2.1        Biostrings_2.72.1      
# [82] miniUI_0.1.2            pbapply_1.7-4           gridExtra_2.3          
# [85] scattermore_1.2         matrixStats_1.5.0       stringi_1.8.7          
# [88] UCSC.utils_1.0.0        lazyeval_0.2.2          codetools_0.2-19       
# [91] tibble_3.3.0            cli_3.6.5               uwot_0.2.3             
# [94] xtable_1.8-4            reticulate_1.43.0       dichromat_2.0-0.1      
# [97] Rcpp_1.1.0              globals_0.18.0          spatstat.random_3.4-2  
# [100] png_0.1-8               spatstat.univar_3.1-4   parallel_4.4.1         
# [103] dotCall64_1.2           bitops_1.0-9            listenv_0.9.1          
# [106] viridisLite_0.4.2       ggridges_0.5.7          purrr_1.1.0            
