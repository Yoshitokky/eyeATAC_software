...
# RNA_d78 <- readRDS("251007_retina_chromatin_d78_RNAseq_No3.rds")
...
# write.csv(peaks_in_region_NOTCH4, "ATAC_peaks_NOTCH4_d78.csv")
result_NOTCH4 <- read.csv("ATAC_peaks_NOTCH4_d78.csv")
result_NOTCH4

target_region_NOTCH4 <- GRanges(seqnames = "chr6",
                                ranges = IRanges(start = 32120000, end = 32200000))
peaks_in_target_region_NOTCH4 <- subsetByOverlaps(peaks, target_region_NOTCH4)
peaks_in_target_region_NOTCH4
# write.csv(peaks_in_target_region_NOTCH4, "ATAC_peaks_NOTCH4_roi_d78.csv")
result_NOTCH4_roi <- read.csv("ATAC_peaks_NOTCH4_roi_d78.csv")
result_NOTCH4_roi
...
# [40] parallelly_1.45.1           codetools_0.2-19            DelayedArray_0.30.1        
# [43] RcppRoll_0.3.1              tidyselect_1.2.1            UCSC.utils_1.0.0           
# [46] farver_2.1.2                matrixStats_1.5.0           spatstat.explore_3.5-3     
# [49] GenomicAlignments_1.40.0    jsonlite_2.0.0              progressr_0.16.0           
# [52] ggridges_0.5.7              survival_3.7-0              tools_4.4.1                
...
# [70] spatstat.data_3.1-8         RSQLite_2.4.3               tidyr_1.3.1                
# [73] generics_0.1.4              data.table_1.17.8           rtracklayer_1.64.0         
# [76] httr_1.4.7                  htmlwidgets_1.6.4           S4Arrays_1.4.1             
# [79] uwot_0.2.3                  pkgconfig_2.0.3             gtable_0.3.6               
# [82] blob_1.2.4                  lmtest_0.9-40               S7_0.2.0                   
...
# [94] rjson_0.2.23                nlme_3.1-165                curl_7.0.0                 
# [97] zoo_1.8-14                  cachem_1.1.0                stringr_1.5.2              
...
# [124] lazyeval_0.2.2              spatstat.geom_3.6-0         Matrix_1.6-5               
# [127] RcppHNSW_0.6.0              bit64_4.6.0-1               future_1.67.0              
