...
RNAseq_ATACseq_merged <- readRDS("241108_retina_chromatin_d78_No1.rds")
# This data is derived from the following code;
# 241108_retina_chromatin_d78_No1.R
...
total_fragments <- CountFragments('GSM5567520_d78_fragments.tsv.gz')
...
RNAseq_ATACseq_merged$nucleosome_group <- ifelse(RNAseq_ATACseq_merged$nucleosome_signal > 2.5, 'NS > 2.5', 'NS < 2.5')
...
saveRDS(object = multiome_d78, file = "241108_retina_chromatin_d78_No2.rds")
