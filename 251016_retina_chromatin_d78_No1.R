...
# gzip -d GSM5567520_d78_fragments.tsv.gz
# bgzip GSM5567520_d78_fragments.tsv
# tabix -p bed GSM5567520_d78_fragments.tsv.gz

fragpath <- 'GSM5567520_d78_fragments.tsv.gz'
...
data_d78 <- CreateSeuratObject(
  counts = chrom_assay,
  assay = "peaks"
)

saveRDS(object = data_d78, file = "241108_retina_chromatin_d78_No1.rds")
