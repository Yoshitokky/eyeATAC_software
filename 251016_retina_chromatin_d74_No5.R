...
# 166396 features across 6265 samples within 2 assays 
# Active assay: RNA (19607 features, 0 variable features)
# 2 layers present: counts, data
# 1 other assay present: peaks
# 2 dimensional reductions calculated: lsi, umap

p1 <- DimPlot(multiome_d74, label = TRUE, pt.size = 0.1) + NoLegend()
p1
...
# saveRDS(multiome_d74, "251007_retina_chromatin_No5.rds")
# multiome_d74 <- readRDS("251007_retina_chromatin_No5.rds")

da_peaks <- FindMarkers(
  object = multiome_d74,
  ident.1 = c("Early markers+ RPC1_d74", "Early markers+ RPC2_d74",
              "Early markers+ RPC3_d74", "Early markers+ RPC4_d74", "MKI67+ RPC_d74"),
  assay = "peaks",
  only.pos = TRUE,
  test.use = 'LR',
  min.pct = 0.05,
...
# saveRDS(da_peaks, "251007_day74_retina_chromatin_No5_da_peaks.rds")
# da_peaks <- readRDS("251007_day74_retina_chromatin_No5_da_peaks.rds")
...
# Testing motif enrichment in 1572 regions
...
# MA0700.2 MA0700.2      187       2150        11.895674             5.3750        2.213149
# MA0069.1 MA0069.1      102       1678         6.488550             4.1950        1.546734
# MA0718.1 MA0718.1      170       2019        10.814249             5.0475        2.142496
# MA0726.1 MA0726.1      154       1867         9.796438             4.6675        2.098862
# pvalue motif.name     p.adjust
# MA0700.2 9.409518e-25       LHX2 2.332060e-24
# MA0069.1 9.727447e-06       PAX6 1.023509e-05
# MA0718.1 4.672506e-21        RAX 9.682472e-21
# MA0726.1 2.635407e-18       VSX2 4.680986e-18

# write.csv(enrichment_moi, "251007_d74_motif_enrichment.csv")
...
multiome <- readRDS("250829_retina_chromatin_d74_ATACseq_No3.rds")
multiome
# An object of class Seurat 
# 166396 features across 6265 samples within 2 assays 
# Active assay: RNA (19607 features, 0 variable features)
...
# (`geom_line()`). 
# 2: Removed 7665 rows containing missing values or values outside the scale
# range (`geom_label_repel()`). 
PlotFootprint(multiome, features = "MA0069.1", label.top = 5)
# Warning messages:
#   1: Removed 5 rows containing missing values or values outside the scale range (`geom_line()`). 
# 2: Removed 7710 rows containing missing values or values outside the scale range
# (`geom_label_repel()`).
...
# 2: Removed 7650 rows containing missing values or values outside the scale range
# (`geom_label_repel()`). 
...
# 2: Removed 7620 rows containing missing values or values outside the scale range
# (`geom_label_repel()`). 

# saveRDS(multiome, "251010_retina_chromatin_d74_No5_FP.rds")
multiome <- readRDS("251010_retina_chromatin_d74_No5_FP.rds")

# motifs <- Motifs(multiome)
# motifs
# # A Motif object containing 633 motifs in 146789 regions
# 
...
# LHX2_chr9
# # write.csv(LHX2_chr9, "FootPrint_LHX2_NOTCH1_d74.csv")
# read.csv("FootPrint_LHX2_NOTCH1_d74.csv")
# # LHX2_NOTCH3
# LHX2_chr19 <- LHX2_pos[seqnames(LHX2_pos) == "chr19"]
# LHX2_chr19
# # write.csv(LHX2_chr19, "FootPrint_LHX2_NOTCH3_d74.csv")
# read.csv("FootPrint_LHX2_NOTCH3_d74.csv")
# # LHX2_NOTCH4
# LHX2_chr6 <- LHX2_pos[seqnames(LHX2_pos) == "chr6"]
# LHX2_chr6
# # write.csv(LHX2_chr6, "FootPrint_LHX2_NOTCH4_d74.csv")
# read.csv("FootPrint_LHX2_NOTCH4_d74.csv")
# # PAX6
...
# PAX6_chr9
# # write.csv(PAX6_chr9, "FootPrint_PAX6_NOTCH1_d74.csv")
# read.csv("FootPrint_PAX6_NOTCH1_d74.csv")
# # PAX6_NOTCH3
# PAX6_chr19 <- PAX6_pos[seqnames(PAX6_pos) == "chr19"]
# PAX6_chr19
# # write.csv(PAX6_chr19, "FootPrint_PAX6_NOTCH3_d74.csv")
# read.csv("FootPrint_PAX6_NOTCH3_d74.csv")
# # PAX6_NOTCH4
# PAX6_chr6 <- PAX6_pos[seqnames(PAX6_pos) == "chr6"]
# PAX6_chr6
# # write.csv(PAX6_chr6, "FootPrint_PAX6_NOTCH4_d74.csv")
# read.csv("FootPrint_PAX6_NOTCH4_d74.csv")
# 
# # RAX
...
# RAX_chr9
# # write.csv(RAX_chr9, "FootPrint_RAX_NOTCH1_d74.csv")
# read.csv("FootPrint_RAX_NOTCH1_d74.csv")
# # RAX_NOTCH3
# RAX_chr19 <- RAX_pos[seqnames(RAX_pos) == "chr19"]
# RAX_chr19
# # write.csv(RAX_chr19, "FootPrint_RAX_NOTCH3_d74.csv")
# read.csv("FootPrint_RAX_NOTCH3_d74.csv")
# # RAX_NOTCH4
# RAX_chr6 <- RAX_pos[seqnames(RAX_pos) == "chr6"]
# RAX_chr6
# # write.csv(RAX_chr6, "FootPrint_RAX_NOTCH4_d74.csv")
# read.csv("FootPrint_RAX_NOTCH4_d74.csv")
# 
# # VSX2
...
# VSX2_chr9
# # write.csv(VSX2_chr9, "FootPrint_VSX2_NOTCH1_d74.csv")
# read.csv("FootPrint_VSX2_NOTCH1_d74.csv")
# # VSX2_NOTCH3
# VSX2_chr19 <- VSX2_pos[seqnames(VSX2_pos) == "chr19"]
# VSX2_chr19
# # write.csv(VSX2_chr19, "FootPrint_VSX2_NOTCH3_d74.csv")
# read.csv("FootPrint_VSX2_NOTCH3_d74.csv")
# # VSX2_NOTCH4
# VSX2_chr6 <- VSX2_pos[seqnames(VSX2_pos) == "chr6"]
# VSX2_chr6
# # write.csv(VSX2_chr6, "FootPrint_VSX2_NOTCH4_d74.csv")
# read.csv("FootPrint_VSX2_NOTCH4_d74.csv")
