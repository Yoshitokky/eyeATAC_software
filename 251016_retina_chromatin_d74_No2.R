...
RNAseq_ATACseq_merged <- readRDS("241108_retina_chromatin_d74_No1.rds")
# This data is derived from the following code;
# 241108_retina_chromatin_d74_No1.R
...
# not run
total_fragments <- CountFragments('GSM5567519_d74_fragments.tsv.gz')
...
saveRDS(object = multiome_d74, file = "241108_retina_chromatin_d74_No2.rds")
