...
# write.csv(peaks_in_region_NOTCH4, "ATAC_peaks_NOTCH4_d74.csv")
result_NOTCH4 <- read.csv("ATAC_peaks_NOTCH4_d74.csv")
result_NOTCH4
...
# write.csv(peaks_in_target_region_NOTCH4, "ATAC_peaks_NOTCH4_roi_d74.csv")
result_NOTCH4_roi <- read.csv("ATAC_peaks_NOTCH4_roi_d74.csv")
result_NOTCH4_roi
